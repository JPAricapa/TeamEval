...
async function main() {
  ...
  const criteriaPares = [
    {
      ...
      order: 1,
      levels: [
        { name: 'Proficiente', score: 4, order: 1, description: 'Aporta al logro de los objetivos, sugiere soluciones y participa activamente en su desarrollo.' },
        { name: 'Aceptable', score: 3, order: 2, description: 'Aporta al logro de los objetivos, sugiere soluciones, pero participa muy poco en su desarrollo.' },
        { name: 'Principiante', score: 2, order: 3, description: 'Pocas veces aporta al logro de los objetivos.' },
        { name: 'Necesita mejorar', score: 1, order: 4, description: 'Nunca realizó aportes al logro de los objetivos.' }
      ]
    },
    {
      name: 'Roles',
      ...
      order: 2,
      levels: [
        { name: 'Proficiente', score: 4, order: 1, description: 'Pone sus habilidades al servicio del equipo. Es responsable con el rol asignado y colabora con los demás integrantes del equipo cuando éstos tienen dificultades.' },
        { name: 'Aceptable', score: 3, order: 2, description: 'Pone sus habilidades al servicio del equipo. Es responsable con el rol asignado, respeta los roles de los demás integrantes del equipo, pero no se integra en un trabajo colaborativo.' },
        { name: 'Principiante', score: 2, order: 3, description: 'Asume un rol específico, pero no respeta las responsabilidades de los demás integrantes del equipo, entorpeciendo su trabajo.' },
        { name: 'Necesita mejorar', score: 1, order: 4, description: 'No asume responsablemente el rol asignado y entorpece el trabajo de los demás integrantes del equipo.' }
      ]
    },
    {
      ...
      order: 3,
      levels: [
        { name: 'Proficiente', score: 4, order: 1, description: 'Es receptivo a aceptar sugerencias u observaciones de los miembros del equipo, y realiza observaciones constructivas a los demás integrantes.' },
        { name: 'Aceptable', score: 3, order: 2, description: 'Es receptivo a aceptar las sugerencias u observaciones de los demás integrantes del equipo, pero no opina constructivamente sobre los demás integrantes.' },
        { name: 'Principiante', score: 2, order: 3, description: 'Realiza observaciones a los demás integrantes del equipo, pero no es receptivo a aceptar las sugerencias que le hagan.' },
        { name: 'Necesita mejorar', score: 1, order: 4, description: 'No acepta las sugerencias u observaciones de los miembros del equipo. Tampoco realiza observaciones constructivas a los demás integrantes.' }
      ]
    }
  ];
  ...
  if (!existingPares) {
    ...
    console.log('✅ Rúbrica de evaluación por pares creada');
  }
  ...
  const criteriaDocente = [
    {
      ...
      order: 1,
      levels: [
        { name: 'Proficiente', score: 4, order: 1, description: 'El equipo establece metas realizables. Las metas y prioridades son claras, justificadas y acordadas por la totalidad de los integrantes del equipo.' },
        { name: 'Aceptable', score: 3, order: 2, description: 'El equipo establece metas realizables. Las metas no están priorizadas, pero son justificadas y acordadas por la totalidad de los integrantes del equipo.' },
        { name: 'Principiante', score: 2, order: 3, description: 'El equipo establece metas difíciles de realizar. Hay algunos acuerdos de realización entre los integrantes del equipo.' },
        { name: 'Necesita mejorar', score: 1, order: 4, description: 'El equipo propone algunas ideas para la construcción de metas, pero sin tener una estructura.' }
      ]
    },
    {
      ...
      order: 2,
      levels: [
        { name: 'Proficiente', score: 4, order: 1, description: 'El equipo muestra un procedimiento formal y consistente para la toma de decisiones. Estas son acordadas por la totalidad de los integrantes del equipo.' },
        { name: 'Aceptable', score: 3, order: 2, description: 'El equipo toma decisiones consistentes, pero sin mostrar un procedimiento ordenado o avalado por la totalidad de los integrantes del equipo.' },
        { name: 'Principiante', score: 2, order: 3, description: 'El equipo toma decisiones sin dimensionar la pertinencia o trascendencia de estas.' },
        { name: 'Necesita mejorar', score: 1, order: 4, description: 'Las decisiones son desafortunadas y recaen en esfuerzos individuales de los integrantes del equipo.' }
      ]
    },
    {
      ...
      order: 3,
      levels: [
        { name: 'Proficiente', score: 4, order: 1, description: 'El equipo tiene evidencias reales de las metas y registros completos del trabajo en equipo que se usan para la supervisión y control.' },
        { name: 'Aceptable', score: 3, order: 2, description: 'El equipo tiene evidencias reales de las metas y registro del trabajo en equipo, pero están incompletos o se usan poco para la supervisión y control.' },
        { name: 'Principiante', score: 2, order: 3, description: 'El equipo tiene evidencias de las metas y registros del trabajo en equipo, pero no corresponden a la realidad.' },
        { name: 'Necesita mejorar', score: 1, order: 4, description: 'El equipo no cuenta con evidencias de las metas establecidas ni mecanismos de supervisión del trabajo del equipo.' }
      ]
    }
  ];
  ...
  if (!existingDocente) {
    ...
    console.log('✅ Rúbrica de heteroevaluación docente creada');
  }
  ...
  if (!existingAuto) {
    ...
    console.log('✅ Rúbrica de autoevaluación creada');
  }
